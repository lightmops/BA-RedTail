...
Die Lichtstärke I zeigt auf, wie stark Licht in eine bestimme Richtung abgestrahlt wird und wird in Candela (cd) angegeben. I wird aus dm Verhältnis von Lichtstrom $\Phi$ zu dem bestrahlten Raumwinkel $/Omega$ errechnet\footnotetext{\cite[27]{ris}} (Gleichung \ref{gl_candela1}).
...
%Abbildung des Spektrums einfügen

\section{Entladungslampen} \label{sec_entladungslampe}
Entladungslampen erzeugen Licht durch eine angelegte Spannung an einem ionisierten Gasgemisch in einem Glasrohr. Bei Leuchtstofflampen wird zusätzlich ein Leuchstoff verwendet, die durch das Gasgemisch angeregt werden.
Man kann die Entladungslampen grob in zwei Kategorien einteilen: die Niederdruck-Entladungslampen und die Hochdruck-Entladungslampen.\\
...
%Abbildung einfügen
An den beiden Enden des Glasrohres liegen Elektroden an. Wenn diese mit einer Spannung versorgt werden, ziehen sich die negativen Elektronen zu der positiven Elektrode. Die positiven Ionen verhalten sich umgekehrt und wandern zur negativen Elektrode. Damit es nicht zum Kurzschluss kommt, wird der Strom durch beispielsweise induktive Vorwiderstände gedrosselt. Die herumschwirrenden Elektronen und Ionen treffen auf neutrale Gasatome. Die Elektronen der Gasatome werden von ihrer Bahn abgedrängt und dabei wird Energie in Form von Strahlung frei\footnote{\cite[93]{ris}}. 
%Abbildung einfügen

Bei der Leuchtstoffröhre beispielsweise handelt es sich bei der freiwerdenden Strahlung um UV-Strahlung (253,7 nm), die nicht vom menschlichen Auge erkennbar ist. Erst wenn diese UV-Strahlung auf die Leuchtschicht am Röhrenrand trifft strahlt diese ein sichtbares Licht ab. Dabei wird nur ein Teil der UV-Strahlung in sichtbares Licht umgesetzt.\footnote{\cite[96]{ris}}
%Abbildung einfügen

Leuchtstofflampen erreichen eine Lichtausbeute von bis zu 116 $\frac{lumen}{Watt}$.

Das Spektrum einer Leuchstofflampe ist schmalbandig.
%Abbildung Spektrum einfügen

Hochdruckentladungslampen dagegen nutzen einen Druck von 0,3 bar bis 10 bar. Sie sind vom Aufbau her ähnlich wie die Niderdruckentladungslampen, aber sie sind in einem kleinem kurzen Entladungsgefäß, da eine lange Glasröhre dem Druck nicht standhält.\\

Wenn bei einer Halogen-Metalldampflampe beispielsweie eine Spannung an den Elektroden anliegt entsteht zwischen den beiden Elektroden ein Lichtbogen. Dieser Lichtbogen regt dann das Gasgemisch der Lampe an und gibt dem Licht so eine Lichtfarbe\footnote{\cite[129]{ris}}
%Abbildung Spektrum einfügen
