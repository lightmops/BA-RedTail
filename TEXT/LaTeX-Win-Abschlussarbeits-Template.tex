...
Auch der TM-30 wurde 2015 von der \glqq Illuminating Engineering Society\grqq (IES) ausgearbeitet um eine Alternative zum CRI zu finden. Wie beim CRI werden ebenso bei der Messung des TM-30 Farbunterschiede zwischen einer Testleuchte und Referenzwerten der selben Farbtemperatur aufgezeigt. Der TM-30 differenziert ähnlich, ob es sich bei der Testleuchte um einen Plank'schen Strahler ($CCT \leq 4500K$) oder einem Tageslicht handelt ($CCT \geq 5500K$). Zwischen 4500K und 5500K wird der proportional überblendet

https://www.energy.gov/sites/prod/files/2016/04/f30/tm-30_fact-sheet.pdf
